...
.buildTable.ft <- function(.x, format, font.size.header, font.size.body, font.family.header, font.family.body, font.bold.header, font.bold.body,
...
.buildTable.gt <- function(.x, format, font.size.header, font.size.body, font.family.header, font.family.body, font.bold.header, font.bold.body,
                            vlines.show, hlines.show, vlines.color, hlines.color, vlines.size, hlines.size,
                            align.header, align.body) {
...
.buildTable.kable <- function(.x, format, font.size.header, font.size.body, font.family.header, font.family.body, font.bold.header, font.bold.body,
                               vlines.show, hlines.show, vlines.color, hlines.color, vlines.size, hlines.size,
                               align.header, align.body) {
